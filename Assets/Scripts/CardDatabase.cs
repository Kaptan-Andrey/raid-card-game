...
public static class CardDatabase
{
    public static List<CardData> BuildMonsterDeck()
    {
        ...
        // Глиф Людоедов — карта типа Магия (без силы), значок 1 Тёмного зерна.
        // Даёт +1 к силе и возможность призвать из Леса более слабых людоедов.
        // magicGrains = [dark,light,calm] = 1 тёмное. TODO: эффект не реализован.
