...
public static class CardDatabase
{
    public static List<CardData> BuildMonsterDeck()
    {
        ...
        // Глиф Людоедов — карта типа Магия (без силы): даёт +1 к силе и возможность
        // призвать из Леса более слабых людоедов. TODO: эффект не реализован;
        // значки зёрен на карте неизвестны (magicGrains = null).
